...
@implementation ThriftRequestDetailsConstants
+ (void) initialize {
}
@end

@implementation ThriftRequestDetails
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"ThriftRequestDetails"];
  if (__pluginName_isset) {
    if (__pluginName != nil) {
  ...
  if (__parameters_isset) {
    if (__parameters != nil) {
      [outProtocol writeFieldBeginWithName: @"parameters" type: TType_STRUCT fieldID: 4];
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"ThriftRequestDetails("];
