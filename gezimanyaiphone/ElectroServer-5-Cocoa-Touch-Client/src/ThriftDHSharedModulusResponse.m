...
@implementation ThriftDHSharedModulusResponseConstants
+ (void) initialize {
}
@end

@implementation ThriftDHSharedModulusResponse
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"ThriftDHSharedModulusResponse"];
  if (__number_isset) {
    if (__number != nil) {
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"ThriftDHSharedModulusResponse("];
