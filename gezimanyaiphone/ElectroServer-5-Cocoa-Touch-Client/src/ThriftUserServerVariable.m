...
@implementation ThriftUserServerVariableConstants
+ (void) initialize {
}
@end

@implementation ThriftUserServerVariable
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"ThriftUserServerVariable"];
  if (__name_isset) {
    if (__name != nil) {
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"ThriftUserServerVariable("];
