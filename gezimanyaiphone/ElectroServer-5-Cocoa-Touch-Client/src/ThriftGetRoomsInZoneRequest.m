...
@implementation ThriftGetRoomsInZoneRequestConstants
+ (void) initialize {
}
@end

@implementation ThriftGetRoomsInZoneRequest
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"ThriftGetRoomsInZoneRequest"];
  if (__zoneId_isset) {
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"ThriftGetRoomsInZoneRequest("];
