...
@implementation ThriftLeaveRoomRequestConstants
+ (void) initialize {
}
@end

@implementation ThriftLeaveRoomRequest
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"ThriftLeaveRoomRequest"];
  if (__zoneId_isset) {
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"ThriftLeaveRoomRequest("];
