...
@implementation ThriftRemoveRoomOperatorRequestConstants
+ (void) initialize {
}
@end

@implementation ThriftRemoveRoomOperatorRequest
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"ThriftRemoveRoomOperatorRequest"];
  if (__zoneId_isset) {
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"ThriftRemoveRoomOperatorRequest("];
