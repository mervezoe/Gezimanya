...
@implementation ThriftUserVariableConstants
+ (void) initialize {
}
@end

@implementation ThriftUserVariable
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"ThriftUserVariable"];
  if (__name_isset) {
    if (__name != nil) {
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"ThriftUserVariable("];
