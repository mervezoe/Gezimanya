...
@implementation ThriftLeaveRoomEventConstants
+ (void) initialize {
}
@end

@implementation ThriftLeaveRoomEvent
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"ThriftLeaveRoomEvent"];
  if (__zoneId_isset) {
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"ThriftLeaveRoomEvent("];
