...
@implementation ThriftRemoveUDPConnectionRequestConstants
+ (void) initialize {
}
@end

@implementation ThriftRemoveUDPConnectionRequest
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"ThriftRemoveUDPConnectionRequest"];
  if (__port_isset) {
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"ThriftRemoveUDPConnectionRequest("];
