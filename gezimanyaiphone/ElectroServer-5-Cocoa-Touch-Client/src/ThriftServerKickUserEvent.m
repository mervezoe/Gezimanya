...
@implementation ThriftServerKickUserEventConstants
+ (void) initialize {
}
@end

@implementation ThriftServerKickUserEvent
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"ThriftServerKickUserEvent"];
  if (__error_isset) {
    [outProtocol writeFieldBeginWithName: @"error" type: TType_I32 fieldID: 1];
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"ThriftServerKickUserEvent("];
